...
function preload() {
  ...
  // document.getElementById("classify-btn").addEventListener("click", classifyCanvas);
}
...
function setup() {
  ...
  let classifyButton = createButton('Guess!');
  classifyButton.position(7, 330);
  classifyButton.mousePressed(classifyCanvas);
